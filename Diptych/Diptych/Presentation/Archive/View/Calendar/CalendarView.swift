...
struct CalendarView: View {
    ...
    @State var monthlyCalendarViewDidAppear = false
    ...
    // MARK: - 월별 캘린더 뷰
    // private var MonthlyCalendarView_: some View {
    //     let _ = print("MonthlyCalendarView called")
    ...
    //                     let _ = print("daysInMonth + firstWeekday:", daysInMonth + firstWeekday)
    //                     VStack {
    //                         Text("\(index)")
    //                             .font(.system(size: 5))
